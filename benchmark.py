...
def main():
    ...
    parser.add_argument("--repeats", type=int, default=3, help="Number of runs per method")
    ...
    print("\nSpeedup (fastmarc total vs pymarc): x{:.2f}".format(base_best / fm_best if fm_best else float('inf')))
